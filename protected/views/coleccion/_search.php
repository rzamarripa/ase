<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'tipoClasificacion_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,"tipoClasificacion_did",CHtml::listData(TipoClasificacion::model()->findAll(), 'id', 'nombre')); ?>		</div>
	</div>
