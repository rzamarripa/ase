...
class EncuestaController extends Controller
{
	...
	{
		$encuestas= Encuesta::model()->findAll();
		...
		if(isset($_GET["estatus"])){
			...
			if($model->save()){
				if($model->estatus_did == 1)
					Yii::app()->user->setFlash("info","Se publicó la Encuesta: " . $model->nombre . ".");
				else
					Yii::app()->user->setFlash("warning","Se dejó de publicar la encuesta: " . $model->nombre . ".");
