	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','update','admin','delete','cambiardatos','subir','cambiar'),
				'users'=>array('@'),
			),
		...
		if(isset($_GET["estatus"])){
			...
			if($model->save()){
				if($model->estatus_did == 1)
					Yii::app()->user->setFlash('info', $model->nombre . " podrá entrar al portal.");
				else
					Yii::app()->user->setFlash('warning',  $model->nombre . " quedó fuera del portal.");
				Yii::app()->db->createCommand("insert into Actividad (mensaje, usuario) Values ('Cambió de Estatus del Usuario " . $model->nombre . " a " . $model->estatus->nombre . "', '" . Yii::app()->user->name . "')")->execute();
