...
$this->pageDescription='Listar publicaciones';
$this->breadcrumbs=array(
	'Publicaciones',
);

$this->menu=array(
	array('label'=>'Crear Publicación','url'=>array('create','tipo'=>$_GET["tipo"])),
);
?>
...
<div class="row">
  <div class="col-lg-12">
    <div class="alert alert-info alert-dismissable">
      ...
      Las publicaciones sirven para permitirles a los usuarios registrados compartir información valiosa.
    </div>
  </div>
</div><!-- /.row -->
<div class="row" style="padding-top:50px;">          
  <div class="col-lg-12">
      <table id="myTable" class="display table table-bordered table-hover table-striped">
        ...
        <tbody>
        	<?php foreach($publicaciones as $noticia){ ?>
	        	<tr>
