	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->labelEx($model,'galeria_did',array('class'=>'control-label col-lg-2')); ?>
		<div class="col-lg-3">
			<?php echo $form->dropDownList($model,'galeria_did',CHtml::listData(Galeria::model()->findAll(), "id", "nombre"),array("class"=>"form-control")); ?>			<?php echo $form->error($model,'galeria_did'); ?>
		</div>
	</div>
	<div class="form-group">
