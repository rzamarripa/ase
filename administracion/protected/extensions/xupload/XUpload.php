    ...
    public function publishAssets() {
        ...
        if (is_dir($assets)) {
            ...
            $messages = CJavaScript::encode(array(
                'fileupload' => array(
                    'errors' => array(
                        "maxFileSize" => $this->t('Archivo muy grande'),
                        "minFileSize" => $this->t('Archivo muy pequeño'),
                        "acceptFileTypes" => $this->t('Tipo de archivo no permitido'),
                        "maxNumberOfFiles" => $this->t('Número máximo de archivo excedido'),
                        "uploadedBytes" => $this->t('Total de bytes excedido'),
                        "emptyResult" => $this->t('Si archivos que subir'),
                    ),
                    'error' => $this->t('Error'),
                    'start' => $this->t('Start'),
