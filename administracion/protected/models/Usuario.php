...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('usuario, contrasena, nombre, tipoUsuario_did', 'required'),
			array('tipoUsuario_did, estatus_did', 'numerical', 'integerOnly'=>true),
			array('nombre, apPaterno, apMaterno, profesion, domCalle, domNo, domColonia, domCP, domMunicipio, domCiudad, domEstado, domPais, telefono, celular, empresa, tema, usuario, contrasena', 'length', 'max'=>50),
