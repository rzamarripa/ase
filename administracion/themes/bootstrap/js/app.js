...
$(document).ready(function() {
	...
	$('#refresh').click(function(e) {
		...
		$.SmartMessageBox({
			title : "<i class='fa fa-refresh' style='color:green'></i> Limpiar configuración Local",
			content : $.widresetMSG || "Quisieras limpiar la configuración local para reiniciar todas las configuraciones guardadas en el equipo local?",
			buttons : '[No][Si]'
