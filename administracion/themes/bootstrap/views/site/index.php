  ...
  <div class="row">
    <div class="col-lg-12">
      <h1>Dashboard <small>Estadísticas</small></h1>
      <ol class="breadcrumb">
        ...
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <p class="announcement-heading"><?php echo Foro::model()->count("estatus_did = 3 && identificador = 0");?></p>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Trafico</h3>
        </div>
  ...
  <div class="row">
    <div class="col-lg-8">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-clock-o"></i> Actividad reciente por el público en general</h3>
        </div>
        <div class="panel-body">
          <div class="list-group">
            <a href="#" class="list-group-item">
              <span class="badge">Justo ahora</span>
              <i class="fa fa-calendar"></i> Calendario actualizado
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">4 minutos atrás</span>
              <i class="fa fa-comment"></i> Post comentado
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">23 minutos atrás</span>
              <i class="fa fa-truck"></i> Se visualizó una galería
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">46 minutos atrás</span>
              <i class="fa fa-comment"></i> Se publicó una noticia
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">1 hora atrás</span>
              <i class="fa fa-user"></i> Un nuevo usuario ha sido agregado
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">2 horas atrás</span>
              <i class="fa fa-check"></i> Se contestó una encuesta
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">ayer</span>
              <i class="fa fa-globe"></i> Un usuario navegó por las noticias
            </a>
            <a href="#" class="list-group-item">
              <span class="badge">dos días atrás</span>
              <i class="fa fa-check"></i> Se contestó una encuesta
            </a>
          </div>
    ...
    <div class="col-lg-4">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-money"></i> Actividad del Administrador</h3>
        </div>
        <div class="panel-body">
